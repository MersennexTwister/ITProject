# [Проект МАРС](umarnurmatov.pythonanywhere.com)
...
Для использования нашей разработки вам необходимо пройти на [наш сайт](umarnurmatov.pythonanywhere.com). Там вы найдёт в числе прочего и инструкцию по эксплуатации.
